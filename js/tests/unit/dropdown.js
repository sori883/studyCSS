$(function () {
  ...
  QUnit.module('dropdowns', {
    beforeEach: function () {
      ...
      $.fn.simplicssDropdown = $.fn.dropdown.noConflict()
    },
    afterEach: function () {
      $.fn.dropdown = $.fn.simplicssDropdown
      delete $.fn.simplicssDropdown
      $('#qunit-fixture').html('')
    }
  })
  ...
  QUnit.test('should throw explicit error on undefined method', function (assert) {
    assert.expect(1)
    var $el = $('<div/>')
    $el.simplicssDropdown()
    try {
      $el.simplicssDropdown('noMethod')
    } catch (err) {
  ...
  QUnit.test('should return jquery collection containing the element', function (assert) {
    assert.expect(2)
    var $el = $('<div/>')
    var $dropdown = $el.simplicssDropdown()
  ...
  QUnit.test('should not open dropdown if target is disabled via attribute', function (assert) {
    ...
    var $dropdown = $('#qunit-fixture').find('[data-toggle="dropdown"]').simplicssDropdown()
  ...
  QUnit.test('should not add class position-static to dropdown if boundary not set', function (assert) {
    ...
    var dropdownHTML = '<div class="tabs">' +
        ...
        '</div>' +
        '</div>'
    var $dropdown = $(dropdownHTML).find('[data-toggle="dropdown"]').simplicssDropdown()
    $dropdown
      .parent('.dropdown')
      .on('shown.sc.dropdown', function () {
  ...
  QUnit.test('should set aria-expanded="false" on target when dropdown menu is hidden', function (assert) {
    ...
    $dropdown
      .parent('.dropdown')
      .on('hidden.sc.dropdown', function () {
  ...
  QUnit.test('should fire show and hide event', function (assert) {
    ...
    $dropdown
      .parent('.dropdown')
      .on('show.sc.dropdown', function () {
        assert.ok(true, 'show was fired')
      })
      .on('hide.sc.dropdown', function () {
  ...
  QUnit.test('should fire shown and hidden event with a relatedTarget', function (assert) {
    ...
    $dropdown.parent('.dropdown')
      .on('hidden.sc.dropdown', function (e) {
        assert.strictEqual(e.relatedTarget, $dropdown[0])
        done()
      })
      .on('shown.sc.dropdown', function (e) {
        assert.strictEqual(e.relatedTarget, $dropdown[0])
        $(document.body).trigger('click')
      })
  ...
  QUnit.test('should fire hide and hidden event with a clickEvent', function (assert) {
    ...
    $dropdown.parent('.dropdown')
      .on('hide.sc.dropdown', function (e) {
  ...
  QUnit.test('should ignore space key events for <input>s within dropdown, and accept up, down and escape', function (assert) {
    ...
    $dropdown
      .parent('.dropdown')
      .one('shown.sc.dropdown', function () {
        assert.ok(true, 'shown was fired')
  ...
  QUnit.test('should call Popper.js and detect navbar on update', function (assert) {
    ...
    var dropdown = $dropdown.data('sc.dropdown')
    dropdown.toggle()
  ...
  QUnit.test('should prevent default event on show method call', function (assert) {
    ...
    $dropdown
      .parent('.dropdown')
      .on('show.sc.dropdown', function (event) {
  ...
  QUnit.test('should prevent default event on hide method call', function (assert) {
    ...
    $dropdown
      .parent('.dropdown')
      .on('hide.sc.dropdown', function (event) {
        event.preventDefault()
        done()
      })
  ...
  QUnit.test('should destroy old popper references on toggle', function (assert) {
    ...
    var $btnDropdown1 = $('.firstBtn').simplicssDropdown()
    var $btnDropdown2 = $('.secondBtn').simplicssDropdown()
    var $firstDropdownEl = $('.first')
    var $secondDropdownEl = $('.second')
    var dropdown1 = $btnDropdown1.data('sc.dropdown')
    var dropdown2 = $btnDropdown2.data('sc.dropdown')
    var spyPopper

    $firstDropdownEl.one('shown.sc.dropdown', function () {
      assert.strictEqual($firstDropdownEl.hasClass('show'), true)
      spyPopper = sinon.spy(dropdown1._popper, 'destroy')
      dropdown2.toggle()
    })

    $secondDropdownEl.one('shown.sc.dropdown', function () {
  ...
  QUnit.test('should hide a dropdown and destroy popper', function (assert) {
    ...
    $dropdownEl.one('shown.sc.dropdown', function () {
      spyPopper = sinon.spy(dropdown._popper, 'destroy')
      dropdown.hide()
    })

    $dropdownEl.one('hidden.sc.dropdown', function () {
      assert.ok(spyPopper.called)
      done()
    })
