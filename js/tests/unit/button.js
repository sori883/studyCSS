$(function () {
  ...
  QUnit.module('button', {
    beforeEach: function () {
      ...
      $.fn.simplicssButton = $.fn.button.noConflict()
    },
    afterEach: function () {
      $.fn.button = $.fn.simplicssButton
      delete $.fn.simplicssButton
      $('#qunit-fixture').html('')
    }
  })
  ...
  QUnit.test('dispose should remove data and the element', function (assert) {
    ...
    assert.ok(typeof $button.data('sc.button') !== 'undefined')

    $button.data('sc.button').dispose()
