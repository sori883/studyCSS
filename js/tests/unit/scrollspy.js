$(function () {
  ...
  QUnit.module('scrollspy', {
    beforeEach: function () {
      ...
      $.fn.simplicssScrollspy = $.fn.scrollspy.noConflict()
    },
    afterEach: function () {
      $.fn.scrollspy = $.fn.simplicssScrollspy
      delete $.fn.simplicssScrollspy
      $('#qunit-fixture').html('')
    }
  })
  ...
  QUnit.test('should throw explicit error on undefined method', function (assert) {
    ...
    $el.simplicssScrollspy()
    try {
      $el.simplicssScrollspy('noMethod')
    } catch (err) {
  ...
  QUnit.test('should return jquery collection containing the element', function (assert) {
    assert.expect(2)
    var $el = $('<div/>').appendTo('#qunit-fixture')
    var $scrollspy = $el.simplicssScrollspy()
  ...
  QUnit.test('should allow passed in option offset method: offset', function (assert) {
    ...
    var testOffsetMethod = function (type) {
      ...
      var scrollspy = $content.data('sc.scrollspy')
