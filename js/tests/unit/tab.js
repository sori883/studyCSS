$(function () {
  ...
  QUnit.module('tabs', {
    beforeEach: function () {
      ...
      $.fn.simplicssTab = $.fn.tab.noConflict()
    },
    afterEach: function () {
      $.fn.tab = $.fn.simplicssTab
      delete $.fn.simplicssTab
      $('#qunit-fixture').html('')
    }
  })
  ...
  QUnit.test('should activate element by tab id', function (assert) {
    ...
    $(tabsHTML).find('li:last-child a').simplicssTab('show')
    assert.strictEqual($('#qunit-fixture').find('.active').attr('id'), 'profile')

    $(tabsHTML).find('li:first-child a').simplicssTab('show')
  ...
  QUnit.test('should activate element by tab id', function (assert) {
    ...
    $(pillsHTML).find('li:last-child a').simplicssTab('show')
    assert.strictEqual($('#qunit-fixture').find('.active').attr('id'), 'profile')

    $(pillsHTML).find('li:first-child a').simplicssTab('show')
    assert.strictEqual($('#qunit-fixture').find('.active').attr('id'), 'home')
  })
  ...
  QUnit.test('should activate element by tab id in nav list', function (assert) {
    ...
    $(tabsHTML).find('a:last-child').simplicssTab('show')
    assert.strictEqual($('#qunit-fixture').find('.active').attr('id'), 'profile')

    $(tabsHTML).find('a:first-child').simplicssTab('show')
    assert.strictEqual($('#qunit-fixture').find('.active').attr('id'), 'home')
  })
  ...
  QUnit.test('should not fire shown when show is prevented', function (assert) {
    ...
    $('<div class="nav"/>')
      .on('show.sc.tab', function (e) {
        e.preventDefault()
        assert.ok(true, 'show event fired')
        done()
      })
      .on('shown.sc.tab', function () {
  ...
  QUnit.test('selected tab should have aria-selected', function (assert) {
    ...
    $tabs.find('li:first-child a').simplicssTab('show')
  ...
  QUnit.test('Nested tabs', function (assert) {
    ...
    $('#tabNested2').on('shown.sc.tab', function () {
      assert.ok($('#x-tab1').hasClass('active'))
      done()
    })

    $('#tab1').on('shown.sc.tab', function () {
      assert.ok($('#x-tab1').hasClass('active'))
  ...
  QUnit.test('should handle removed tabs', function (assert) {
    ...
    $('#secondNav').on('shown.sc.tab', function () {
    ...
    $('#btnClose').one('click', function () {
      ...
      $(tabId).remove()
      $('.nav-tabs a:last').simplicssTab('show')
    })
      .trigger($.Event('click'))
  })
